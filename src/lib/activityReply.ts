...
const replies: Record<Language, Record<Activity, string[]>> = {
  ...
  ru: {
    swim: [
      'Купание в озере звучит как очень приятный момент. Что понравилось больше всего: вода, место или ощущение после?',
      'Здорово, что тебе понравилось купаться. Похоже, это добавило дню лёгкости. Хочется запомнить этот момент?',
    ],
    walk: [
